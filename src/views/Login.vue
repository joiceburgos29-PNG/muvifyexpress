    ...
    <div class="w-full max-w-md">
      <div class="bg-white rounded-2xl shadow-lg p-8">
        <div class="flex justify-center mb-8">
          <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/LOGO.MUVIFY.EXPRESS-tUJWSv6v0CIkHijScsOU1nBD6PpmQL.png" alt="Muvify Express" class="h-24 w-auto">
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="relative">
            ...
            <div class="relative flex justify-center text-sm">
              <span class="px-2 bg-white text-gray-500">O continúa como</span>
            </div>
          </div>

          <router-link 
            to="/"
            class="w-full py-3 px-4 bg-gray-100 hover:bg-gray-200 transition rounded-lg text-center font-semibold text-gray-900"
          >
            ← Volver a inicio
          </router-link>
        </div>
